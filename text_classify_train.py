...
try:
    args = get_args('config/text_classify_args.txt')
...
def mymodel_train(args, logger, train_dataloader, validation_dataloader):
    ...
    for _ in trange(epochs, desc='Epochs'):
        ...
        adjust_learning_rate(optimizer1, 0.8)
        adjust_learning_rate(optimizer2, 0.8)
        try:
...
if __name__ == "__main__":
    ...
    acc_records = mymodel_test(logger, test_dataloader, embedding, model)
